...
const en = {
  ...
  "room.nodes.desc": "Add your own LiveKit nodes to this room",
  "room.nodes.selectLabel": "Select a node",
  "room.nodes.add": "Add",
  "room.nodes.added": "Node added",
  "room.nodes.col.name": "Node",
  "room.nodes.col.status": "Status",
  "room.nodes.primary": "Primary",
  "room.nodes.secondary": "Secondary",
  "room.nodes.setPrimary": "Set as primary",
  "room.nodes.primarySet": "Primary node updated",
  "room.nodes.grantTitle": "Grant node access",
  "room.nodes.grantDesc": "Give {name} access to one of your nodes",
  "room.nodes.grant": "Grant",
  "room.nodes.granted": "{name} can now use that node",
  ...
  "sync.new.accessLabel": "Who can control",
  "sync.accessLabel": "Control access",
  "sync.accessMembers": "All members",
  "sync.accessPublishers": "Publishers only",
  "sync.accessOwner": "Owner only",
  "sync.accessUpdated": "Access updated",
